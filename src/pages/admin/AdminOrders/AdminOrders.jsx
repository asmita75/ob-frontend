...
import { UpdateOrderStatusApi, getAllOrdersApi, getOrdersByUserApi } from '../../../apis/Api'
                ...
                orders.map((order) => (
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    >Pending</button></li>
                                    <li><button class="dropdown-item"
                                    onClick={()=> handleChangeStatus(order._id,"In prgress")}
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            ...
                            <div>
                                <h6>Shipping info : {order.shippigAddress}</h6>
                            </div>
                            <div>
